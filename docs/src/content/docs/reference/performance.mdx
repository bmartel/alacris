...
<table class="sizes">
  ...
  <tbody>
    <tr><td>`alacris.js` — everything</td><td>16.47 kB</td><td>**6.45 kB**</td><td>5.87 kB</td></tr>
    <tr><td>`store.js`</td><td>2.14 kB</td><td>**1.03 kB**</td><td>0.94 kB</td></tr>
    <tr><td>`context.js`</td><td>0.91 kB</td><td>**0.54 kB**</td><td>0.46 kB</td></tr>
    <tr><td>`signal.js` — no DOM</td><td>2.34 kB</td><td>**1.03 kB**</td><td>0.96 kB</td></tr>
  </tbody>
</table>
