...
The URLs pin `@alacris/core@0.11.2` and `@alacris/ui@0.2.4`. Never mix two versions of
...
<Tabs>
  ...
  <TabItem label="unpkg">
    ...
    {
      "imports": {
        "@alacris/core": "https://unpkg.com/@alacris/core@0.11.2/dist/alacris.js",
        "@alacris/ui": "https://unpkg.com/@alacris/ui@0.2.4/src/index.js"
      }
    }
    </script>
    ```
