...
Pin both packages in production (`@alacris/core@0.9.2`, `@alacris/ui@0.1`). Never mix pinned and unpinned URLs in one page.
...
<Tabs>
  <TabItem label="jsDelivr">
    ...
    {
      "imports": {
        "@alacris/core": "https://cdn.jsdelivr.net/npm/@alacris/core@0.9.2/dist/alacris.js",
        "@alacris/ui": "https://cdn.jsdelivr.net/npm/@alacris/ui/src/index.js"
      }
    }
    </script>
  ...
  <TabItem label="unpkg">
    ...
    {
      "imports": {
        "@alacris/core": "https://unpkg.com/@alacris/core@0.9.2/dist/alacris.js",
