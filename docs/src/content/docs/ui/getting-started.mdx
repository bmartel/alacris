...
- `http://localhost:5173/ui/` — every component plus a live theme playground, composed from the same tags you import from npm.
- `http://localhost:5173/starter/` — a small app that **uses** those tags. Copy that folder as an install guide; it is not the published package.
