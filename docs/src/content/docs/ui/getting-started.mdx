...
The URLs pin `@alacris/core@0.11.3` and `@alacris/ui@0.3.0`. Never mix two versions of
...
<Tabs>
  ...
  <TabItem label="unpkg">
    ...
    {
      "imports": {
        "@alacris/core": "https://unpkg.com/@alacris/core@0.11.3/dist/alacris.js",
        "@alacris/ui": "https://unpkg.com/@alacris/ui@0.3.0/src/index.js"
      }
    }
    </script>
    ```
