...
import storeDemo from '../../../demos/store.js?raw';
...
<Demo
  code={storeDemo}
  preview={`<demo-store></demo-store>`}
  title="Path-level updates, live"
  open={false}
/>
...
this takes selecting a row from **0.61 ms to 0.010 ms**, which is the floor.
