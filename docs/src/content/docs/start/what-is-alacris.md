...
whole runtime is 6.56 kB gzipped, it is ESM-only, it has no dependencies, and it
needs no build step.
...
- **Size.** 6.56 kB gzipped for the entire runtime. The store and context add-ons
