...
whole runtime is 6.60 kB gzipped, it is ESM-only, it has no dependencies, and it
needs no build step.
...
- **Size.** 6.60 kB gzipped for the entire runtime. The store and context add-ons
