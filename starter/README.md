...
<script type="importmap">
{
  "imports": {
    ...
    "@alacris/ui": "https://cdn.jsdelivr.net/npm/@alacris/ui@0.2.1/src/index.js",
    "@alacris/ui/theme": "https://cdn.jsdelivr.net/npm/@alacris/ui@0.2.1/src/theme/index.js",
    "@alacris/ui/components/": "https://cdn.jsdelivr.net/npm/@alacris/ui@0.2.1/src/components/"
  }
}
</script>
<script type="module">
...
The URLs pin `@alacris/core@0.11.0` and `@alacris/ui@0.2.1`. Never mix two versions of `@alacris/core` on one page — two copies means two reactive graphs.
...
pin "@alacris/ui", to: "https://cdn.jsdelivr.net/npm/@alacris/ui@0.2.1/src/index.js"
```
