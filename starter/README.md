...
The URLs pin `@alacris/core@0.11.4` and `@alacris/ui@0.4.7`. Never mix two versions of `@alacris/core` on one page — two copies means two reactive graphs.
...
pin "@alacris/ui", to: "https://cdn.jsdelivr.net/npm/@alacris/ui@0.4.7/src/index.js"
```
