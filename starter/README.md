...
The URLs pin `@alacris/core@0.11.1` and `@alacris/ui@0.2.3`. Never mix two versions of `@alacris/core` on one page — two copies means two reactive graphs.
...
```ruby
# config/importmap.rb
pin "@alacris/core", to: "https://cdn.jsdelivr.net/npm/@alacris/core@0.11.1/dist/alacris.js"
pin "@alacris/ui", to: "https://cdn.jsdelivr.net/npm/@alacris/ui@0.2.3/src/index.js"
```
