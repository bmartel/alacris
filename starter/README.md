...
The URLs pin `@alacris/core@0.11.5` and `@alacris/ui@0.5.1`. Never mix two versions of `@alacris/core` on one page — two copies means two reactive graphs.
...
pin "@alacris/ui", to: "https://cdn.jsdelivr.net/npm/@alacris/ui@0.5.1/src/index.js"
```
