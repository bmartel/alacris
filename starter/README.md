...
The URLs pin `@alacris/core@0.11.1` and `@alacris/ui@0.2.2`. Never mix two versions of `@alacris/core` on one page — two copies means two reactive graphs.
...
pin "@alacris/ui", to: "https://cdn.jsdelivr.net/npm/@alacris/ui@0.2.2/src/index.js"
```
