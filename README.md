...
```html
<script type="module">
  import { define, html, signal } from 'https://unpkg.com/@alacris/core@0.11.1';
...
```js
import { define, html, signal } from 'https://unpkg.com/@alacris/core@0.11.1/dist/alacris.js';
// or jsDelivr
import { define, html, signal } from 'https://cdn.jsdelivr.net/npm/@alacris/core@0.11.1/+esm';
```

Just the reactive core, without the renderer (1.03 KB):

```js
import { signal, computed, effect } from 'https://unpkg.com/@alacris/core@0.11.1/dist/signal.js';
```
...
```html
<script type="module" src="https://unpkg.com/@alacris/core@0.11.1/dist/alacris.js"></script>
