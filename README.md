...
```html
<script type="module">
  import { define, html, signal } from 'https://unpkg.com/@alacris/core@0.11.2';
...
```js
import { define, html, signal } from 'https://unpkg.com/@alacris/core@0.11.2/dist/alacris.js';
// or jsDelivr
import { define, html, signal } from 'https://cdn.jsdelivr.net/npm/@alacris/core@0.11.2/+esm';
```

Just the reactive core, without the renderer (1.03 KB):

```js
import { signal, computed, effect } from 'https://unpkg.com/@alacris/core@0.11.2/dist/signal.js';
```
...
```html
<script type="module" src="https://unpkg.com/@alacris/core@0.11.2/dist/alacris.js"></script>
